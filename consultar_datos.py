...
def obtener_clima_por_dias():
    ...
    try:
        ...
        params = {
            "latitude": lat,
            "longitude": lon,
            "daily": ["temperature_2m_mean", "relative_humidity_2m_mean", "leaf_wetness_probability_mean", "precipitation_probability_mean", "wind_speed_10m_mean", "winddirection_10m_dominant", "et0_fao_evapotranspiration_sum"],
            "timezone": "auto",
        ...
        data_dict = {
            ...
            "leaf_wetness": daily.Variables(2).ValuesAsNumpy(),
